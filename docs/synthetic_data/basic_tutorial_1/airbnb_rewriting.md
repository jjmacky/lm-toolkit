...
In this tutorial, we'll create some basic synthetic data as an exercise. The Python notebook for the project can be found on my GitHub [here](https://github.com/jjmacky/prompt_cookbook/blob/main/docs/synthetic_data/basic_tutorial_1/airbnb_rewriting.ipynb).
